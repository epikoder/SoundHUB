<nav>
    <div class="bg-gray-900 flex sm:h-20 md:h-20 lg:h-16 xl:h-16 w-full justify-between fixed z-40 top-0 text-center">
        <div class="p-2 sm:w-16 md:w-16 lg:w-16 xl:w-16 lg:ml-4 xl:ml-4">
            <button class="w-full p-2 h-full focus:outline-none">
                <img id="menu" onclick="menu()" class="menu"
        ...
        <div class="sm:hidden w-2/5 px-2 py-3">
            <input type="search" name="search" class="sm:hidden w-full h-10 outline-none px-5 bg-gray-100 rounded-md"
                placeholder="search">
        </div>
        <div class="sm:hidden flex">
            <button class="sm:hidden focus:outline-none w-16 m-auto">
                @if ($user ?? '')
                    ...
                    @else
                        <a href=" {{ route('paystack/pay') }} " class="p-2 bg-blue-500 text-white rounded">
                            upload
                        </a>
                    @endif
                @else
        ...
        <div class="left-auto right-0 md:hidden lg:hidden xl:hidden flex align-right" id="small-buttons">
            <button class="m-auto w-10 focus:outline-none md:hidden lg:hidden xl:hidden">
                <img class="bg-white rounded-full p-2"
