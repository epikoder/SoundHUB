...
<div class="w-full flex pt-4">
    <div class="sm:w-3/4 md:w-2/4 lg:w-2/4 xl:w-2/4 m-auto border-2 p-4">
        <button id="close" class="cursor-pointer">
        ...
        <form action={{route('media.upload')}} method="POST" enctype="multipart/form-data" class="px-4">
            <div class="text-center flex-col my-2">
                ...
                <input type="file" name="track" class="text-center outline-none" accept="audio/*">
            </div>
            <div class="flex justify-center">
                ...
                <button id="add" class="cursor-pointer p-1 outline-none bg-blue-500 text-sm text-white rounded-md">Add</button>
            </div>
