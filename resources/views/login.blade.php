                ...
                <div class="block p-4">
                    ...
                    <div class="flex">
                        <input type="password" name="password"
                            class="password w-full border-b border-gray-600 focus:border-teal-500 hover:border-teal-500 input focus:outline-none my-2 p-1"
