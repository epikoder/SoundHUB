...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(".name").on("keyup", function () {
  var name = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".name").val();

  if (name.length <= 5 || name.indexOf(" ") > -1) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".name_error").removeClass("text-blue-500");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".name_error").addClass("text-red-600");
    return false;
  }

  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".name_error").removeClass("text-red-600");
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".name_error").addClass("text-blue-500");
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(".email").on("keyup", function () {
  var email = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".email").val();

  if (!regexEmail.test(email) || email.indexOf(" ") > -1) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".email_error").removeClass("text-blue-500");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".email_error").addClass("text-red-600");
    return false;
  }

  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".email_error").removeClass("text-red-600");
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".email_error").addClass("text-blue-500");
});
...
/***/ 2:
/*!****************************************!*\
  !*** multi ./resources/js/app/regs.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\efedu\LabCodes\SoundHUB\api\resources\js\app\regs.js */"./resources/js/app/regs.js");
