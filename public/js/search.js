...
var livesearch;
var CT = axios__WEBPACK_IMPORTED_MODULE_1___default.a.CancelToken;
var cancel;
jquery__WEBPACK_IMPORTED_MODULE_0___default()(".search").on("focus", function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".search-bar").show();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".main-search").trigger('focus');
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(".btn-search").on("click", function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".search-bar").show();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".main-search").trigger('focus');
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(".main-search").on("focusout", function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.livesearch').hide();
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(".main-search").on("focus", function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".livesearch").show();
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(".close-search").on("click", function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".livesearch").remove();
  setTimeout(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.search-bar').hide();
  }, 250);
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(".main-search").on("keyup", function (e) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(search, {
...
function searchResult(data) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("nav").append(livesearch);
  var search = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".node").get([0]); // artist
...
module.exports = __webpack_require__(/*! C:\Users\efedu\LabCodes\SoundHUB\api\resources\js\search.js */"./resources/js/search.js");
